  ...
  return (
    <footer className="relative text-[#FFFFFF] overflow-hidden">
      ...
      <ParallaxBg
        ...
        strength={15}
      />
      <div className="relative z-10 max-w-[1920px] mx-auto px-8 lg:px-12 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        {/* Brand */}
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <p className="text-[#6B6B6B] text-sm max-w-xs leading-relaxed" style={{ fontFamily: "var(--font-dm-sans)" }}>
        ...
        <div className="flex flex-col gap-3">
          ...
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-sm text-[#6B6B6B] hover:text-[#FFFFFF] transition-colors"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" aria-label="Twitter / X" className="text-[#6B6B6B] hover:text-[#FFFFFF] transition-colors">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="mt-4">
            <Link
              href="/contact"
              className="inline-block border border-[#FFFFFF]/30 text-[#FFFFFF] px-5 py-2.5 text-xs font-medium uppercase tracking-widest hover:bg-[#FFFFFF]/10 transition-colors"
              style={{ fontFamily: "var(--font-dm-sans)" }}
            >
              Start an Engagement
            </Link>
      ...
      <div className="relative z-10 border-t border-white/10 py-6">
        <p className="text-center text-xs text-[#6B6B6B]" style={{ fontFamily: "var(--font-dm-sans)" }}>
